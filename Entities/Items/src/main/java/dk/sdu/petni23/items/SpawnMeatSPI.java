...
public class SpawnMeatSPI implements IEntitySPI {
    ...
    static {
        ...
        var img = new Image(Objects.requireNonNull(SpawnMeatSPI.class.getResourceAsStream("/itemsprites/Meat_Spawn.png")));
    ...
    public IEntitySPI.Type getType() {
        return Type.SPAWN_MEAT;
    }



    Entity spawnMeat(Vector2D pos) {
        Entity spawn = new Entity(Type.SPAWN_MEAT);
        ...
        duration.onDeath = node -> Engine.addEntity(MeatSPI.meat(pos));

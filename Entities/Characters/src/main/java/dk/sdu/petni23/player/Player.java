...
public class Player
{
    ...
    static private IEntitySPI getDamageSPI() {
        for (var spi : Engine.getEntitySPIs()) {
            if (spi.getType() == IEntitySPI.Type.DAMAGE)
                return spi;
        }
        return null;
    }
